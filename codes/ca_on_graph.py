...
if __name__ == "__main__":
    ...
    for rep in range(MAX_REPS):
        if rep % 5 == 0:
            ...
            plt.imshow(visualization_matrix,interpolation='none',cmap='seismic',vmin=0,vmax=2)
            if graph == "star":
                img_name = "C:\\Users\\Jason\\Desktop\\Clinic Research\\CellAutomata\\Codes\\images_star\\" + str(rep//5).zfill(5) + '.jpg'
            elif graph == "cycle":
                img_name = "C:\\Users\\Jason\\Desktop\\Clinic Research\\CellAutomata\\Codes\\images_cycle\\" + str(rep//5).zfill(5) + '.jpg'
            elif graph == "complete":
                img_name = "C:\\Users\\Jason\\Desktop\\Clinic Research\\CellAutomata\\Codes\\images_complete\\" + str(rep//5).zfill(5) + '.jpg'
